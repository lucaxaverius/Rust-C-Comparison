...
OPERATIONS = ["take_and_release"]

# Patterns for extracting C and Rust metrics
patterns = {
    "c_take_and_release": r"C-Mutex-Benchmark: Total lock/unlock time: (\d+) ms",
    
    "rust_take_and_release": r"Rust_Mutex_Benchmark: Total lock/unlock time: (\d+) ms",
}
