#!/bin/bash
MODULE_NAME="C-SpinLock-Benchmark"
MODULE_FILE_NAME="spinlock_benchmark"  # Name of your C kernel module
MODULE_SOURCE="spinlock_benchmark.c"
...
wait_for_test() {
    ...
    while true; do
        if dmesg | tail -n 10 | grep -q "C-SpinLock-Benchmark: Test module completed"; then
