...
def plot_statistics(total_times, min_time, max_time, avg_time, var_time, median_time):
    ...
    plt.ylabel("Time (ms)")
    #plt.title("Rust Spinlock - Lock/Unlock 15,000,000 Times")
    plt.title("C Spinlock - Lock/Unlock 15,000,000 Times")
    ...
    # Save the plot
    plt.savefig("spinlock_benchmark_plot.png")
    print("Plot saved as 'spinlock_benchmark_plot.png'.")
