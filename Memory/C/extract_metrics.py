...
FUNCTIONS = ["allocate_page", "write_page", "read_page"]
AUXILIARY_FUNCTIONS = {
    "read_page": "memcpy_orig",
    "write_page": "memset_orig"
}
TMP_FILE = "tmp_report.txt"
OUTPUT_CSV = "./results/metrics.csv"

# Regex pattern to match target functions and auxiliary functions
