#!/bin/bash
MODULE_NAME="C-RBTree-Benchmark"
MODULE_FILE_NAME="rbtree_benchmark"  # Name of your C kernel module
MODULE_SOURCE="rbtree_benchmark.c"
...
wait_for_test() {
    ...
    while true; do
        if dmesg | tail -n 10 | grep -q "C-RBTree-Benchmark: Module initialization complete"; then
